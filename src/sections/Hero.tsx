  ...
  return (
    <section className="relative overflow-hidden bg-[#240d47] pt-24 md:pt-40 pb-20 md:pb-40 lg:pb-48 min-h-screen md:min-h-[680px] flex items-center font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div 
          className="absolute inset-x-0 top-0 bottom-[-60px] bg-cover bg-no-repeat lg:bg-center lg:bg-[size:100%] hidden lg:block opacity-100 transition-opacity duration-300"

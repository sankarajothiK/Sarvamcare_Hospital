      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-3 text-center md:text-left">
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
          ...
          <Link
            to="/login"
            title="Admin Portal"
            className="p-1 rounded-full bg-white/5 border border-white/10 hover:bg-white/15 text-indigo-200 hover:text-white transition-colors duration-200 flex items-center justify-center pointer-events-auto"
          >
            <Lock className="h-3 w-3 text-[#D8B35A]" />
          </Link>
